...
| link_to_subnet                    | Specifies an existing subnet where this AKS cluster should be attached.                          |
| link_to_pod_subnet                | Specifies an existing subnet where this AKS cluster should be attached.                          |
